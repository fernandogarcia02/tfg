...
$jugadore = $jugadores->traerTarjetas();
...
<body>
    ...
    <div class="mini-nav">
        <ul class="nav nav-pills">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="tarjetas.php">Tarjetas</a>
            </li>
            <li class="nav-item">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                foreach ($jugadore as $key => $value) {
                    ...
                    echo "<td> <strong>" . $value->total_tarjetas . "</strong></td>";
                    echo "<td>" . $value->tarjetas_amarillas . "</td>";
                    echo "<td>" . $value->tarjetas_rojas . "</td>";
                    echo "</tr>";
                }
                ?>
            </tbody>
