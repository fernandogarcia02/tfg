...
$jugadores->crear_Jugador($equipo,$nombre,$posicion,$camiseta,$fecha,$nacionalidad,$altura,$peso,$goles,$asistencias,$partidos,$amarillas,$rojas,$nombre_archivo,$descripcion);
