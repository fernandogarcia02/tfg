...
$jugadore = $jugadores->traerAsistentes();
...
<body>
    ...
    <div class="mini-nav">
        <ul class="nav nav-pills">
            <li class="nav-item">
                <a class="nav-link" href="estadisticas.php">Goleadores</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="tarjetas.php">Tarjetas</a>
            </li>
            <li class="nav-item">
                <a class="nav-link active" href="asistencias.php">Asistencias</a>
            </li>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                foreach ($jugadore as $key => $value) {
                    ...
                    echo "<td><strong>" . $value->asistencias . "</strong></td>";
                    echo "<td>" . $value->partidos_jugados . "</td>";
                    if ($value->partidos_jugados == 0) {
                        echo "<td>0.00</td>";
                    }else{
                    echo "<td>" . number_format($value->asistencias / $value->partidos_jugados,2,",",".") . "</td>";}
                    echo "</tr>";
                }
                ?>
            </tbody>
