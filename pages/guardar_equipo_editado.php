...
$equipos->editar_Equipo($equipo_id,$nombre,$descripcion,$nombre_archivo,$fundacion,$sede,$entrenador,$estadio,$color_primario,$color_secundario,$pagina,$twitter,$tiktok,$insta);
