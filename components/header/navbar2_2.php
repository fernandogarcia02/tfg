    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item <?php echo strpos($current_page, 'estadisticas.php') !== false || strpos($current_page, 'tarjetas.php') !== false || strpos($current_page, 'asistencias.php') !== false   ? 'active' : ''; ?>">
